...
const FIELDS: (keyof Fields)[] = ['name', 'date', 'address', 'contacts', 'description', 'notes'];
const LABELS = ['Название', 'Дата проведения', 'Адрес', 'Контактное лицо', 'Описание', 'Примечание'];

const NewEventForm = ({
    data, errors, error, isFetching, onChange, onSubmit
}: Props): JSX.Element => {
