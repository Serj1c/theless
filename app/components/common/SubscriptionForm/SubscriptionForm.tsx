...
import { Jsonrpc, JsonrpcError, HTTPError, jsonRpcClient } from 'utils/jsonrpc';
import Form, { OnSubmitParams } from './components/Form/Form';
import Success from './components/Success/Success';
import { Col, Row } from 'components/ui';
import { reducer, initialState, FailurePayload } from './reducers/reducers';
...
const SubscriptionForm = ({ title, params = {} }: Props): JSX.Element => {
    ...
    const handleSubmit = useCallback(async ({ email }: OnSubmitParams): Promise<void> => {
        try {
